# scripts/G_6_analyze_observability.py
import os
import sys
...
def run_analysis(results_base):
    ...
    # Analyze Cilium
    cilium_metrics = os.path.join(results_base, "G_6_cilium", "G_6_cni_metrics.txt")
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python3 G_6_analyze_observability.py <results_dir>")
        sys.exit(1)
